                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#" onclick="abrirPage('empresa')">Empresas</a></li>
                            <li><a class="dropdown-item" href="#" onclick="abrirPage('usuario')">Usuários</a></li>
                            <li><a class="dropdown-item" href="#"onclick="abrirPage('perfil')">Perfil</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
